...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0">
            <i class="fas fa-plus-circle text-primary me-2"></i>Tambah Transaksi
        </h4>
        <p class="text-muted mb-0" style="font-size: 0.9rem;">Input data transaksi baru</p>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="transaction_type" class="form-control @error('transaction_type') is-invalid @enderror" 
                           value="{{ old('transaction_type') }}" required placeholder="Gaji, Bonus, THR, dll">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                              rows="3" placeholder="Deskripsi transaksi">{{ old('description') }}</textarea>
